...
<code class="html" x-include="/admin-console/components/commands/RemoveProgramItemConference.html"></code>

#### The basic concept
```html
<draftsman-mutation command="RemoveProgramItemConference" x-include="/prepared-statements/commands/RemoveProgramItemConference.txt">
</draftsman-mutation>
```
Registers a prepared statement (/prepared-statements/commands/RemoveProgramItemConference.txt) as a command (RemoveProgramItemConference) in the Draftsman framework. 
The body of the tag is imported by vimesh-ui.
...
the command.
```html
<div style="display:none;" id="RemoveProgramItemConference" x-include="/form-definitions/RemoveProgramItemConference.json"></div>
```
...
```javascript
$store.mutation.send('RemoveProgramItemConference',{all-form-data});
```
...
```html
<draftsman-trace command="RemoveProgramItemConference" 
                 status="success" 
                 @trace="
                    Draftsman.empty_track_and_trace_log();
                    $dispatch('setdata', { command: 'RemoveProgramItemConference', data: {} });">
</draftsman-trace>
```
